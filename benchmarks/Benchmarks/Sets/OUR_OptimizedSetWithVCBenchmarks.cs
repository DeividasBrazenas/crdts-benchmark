...
namespace Benchmarks.Sets
{
    ...
    public class OUR_OptimizedSetWithVCBenchmarks
    {
        ...
        private void ConvergentAdd(CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType> sourceReplica, TestType value, VectorClock vectorClock, List<CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
        ...
        private void ConvergentUpdate(CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType> sourceReplica, TestType value, VectorClock vectorClock, List<CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
            var observedTags = sourceReplica.GetTags(value.Id);
            sourceReplica.LocalUpdate(value, observedTags, vectorClock);
        ...
        private void ConvergentRemove(CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType> sourceReplica, TestType value, VectorClock vectorClock, List<CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
            var observedTags = sourceReplica.GetTags(value.Id);
            sourceReplica.LocalRemove(value, observedTags, vectorClock);
