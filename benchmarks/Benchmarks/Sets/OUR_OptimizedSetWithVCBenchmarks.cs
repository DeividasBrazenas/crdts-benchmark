...
namespace Benchmarks.Sets
{
    ...
    public class OUR_OptimizedSetWithVCBenchmarks
    {
        ...
        private Dictionary<Node, CRDT.Application.Commutative.Set.OUR_OptimizedSetWithVCService<TestType>> _commutativeReplicas;
        private Dictionary<Node, CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> _convergentReplicas;
        ...
        {
            TestType value;
            CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType> replica;
            List<CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas;
        ...
        {
            TestType value;
            CRDT.Application.Commutative.Set.OUR_OptimizedSetWithVCService<TestType> replica;
            List<CRDT.Application.Commutative.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas;
            var clock = new VectorClock(_nodes);
        ...
        private void CommutativeDownstreamAdd(TestType value, Guid tag, VectorClock clock, List<CRDT.Application.Commutative.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
        ...
        private void CommutativeDownstreamUpdate(TestType value, Guid tag, VectorClock clock, List<CRDT.Application.Commutative.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
            foreach (var downstreamReplica in downstreamReplicas)
            {
        ...
        private void CommutativeDownstreamRemove(TestType value, List<Guid> tags, VectorClock clock, List<CRDT.Application.Commutative.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
            foreach (var downstreamReplica in downstreamReplicas)
            {
        ...
        private Dictionary<Node, CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> CreateConvergentReplicas(List<Node> nodes)
        {
            var dictionary = new Dictionary<Node, CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>>();

            foreach (var node in nodes)
            {
                var repository = new OUR_OptimizedSetWithVCRepository();
                var service = new CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>(repository);
        ...
        private void ConvergentDownstreamMerge(ImmutableHashSet<OUR_OptimizedSetWithVCElement<TestType>> elements, List<CRDT.Application.Convergent.Set.OUR_OptimizedSetWithVCService<TestType>> downstreamReplicas)
        {
            foreach (var downstreamReplica in downstreamReplicas)
            {
