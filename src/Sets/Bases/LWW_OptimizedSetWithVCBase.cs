...
namespace CRDT.Sets.Bases
{
    ...
    {
        public ImmutableHashSet<LWW_OptimizedSetWithVCElement<T>> Elements { get; protected set; }
        ...
        protected LWW_OptimizedSetWithVCBase(ImmutableHashSet<LWW_OptimizedSetWithVCElement<T>> elements)
        {
            Elements = elements;
        }
