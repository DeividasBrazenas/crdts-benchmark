...
namespace CRDT.Application.UnitTests.Commutative
{
    public class OUR_OptimizedSetServiceTests
    {
        ...
        [Theory]
        [AutoData]
        public void Add_WithExistingValues_AddsElementToTheRepository(List<OUR_OptimizedSetElement<TestType>> adds, TestType value, Guid tag, long timestamp)
        {
        ...
        [Theory]
        [AutoData]
        public void Add_WithDifferentTag_AddsElementToTheRepository(List<OUR_OptimizedSetElement<TestType>> adds, TestType value, Guid tag, Guid otherTag, long timestamp)
        {
            _repository.PersistElements(adds);
