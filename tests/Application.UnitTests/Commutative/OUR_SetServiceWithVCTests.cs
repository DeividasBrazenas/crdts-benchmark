...
namespace CRDT.Application.UnitTests.Commutative
{
    public class OUR_SetWithVCServiceTests
    {
        ...
        [Theory]
        [AutoData]
        public void Add_WithDifferentTag_AddsElementToTheRepository(HashSet<OUR_SetWithVCElement<TestType>> adds, TestType value, Guid tag, Guid otherTag, Node node)
        {
            var clock = ImmutableSortedDictionary<Node, long>.Empty;
